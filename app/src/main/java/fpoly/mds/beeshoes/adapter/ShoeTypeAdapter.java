...
public class ShoeTypeAdapter extends RecyclerView.Adapter<ShoeTypeAdapter.ViewHolder> {
    ...
    private final funcionInterface funcionInterface;

    public ShoeTypeAdapter(Context context, ArrayList<ShoeType> list, funcionInterface funcionInterface) {
        this.context = context;
        this.list = list;
        this.funcionInterface = funcionInterface;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            Picasso.get().load(img).placeholder(R.drawable.img).error(R.drawable.ic_camera)
    ...
    private void openDialogChucNang(String id) {
        ...
        binding.btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                funcionInterface.delete(id);
                dialog.dismiss();
            }
        });
    }

    public interface funcionInterface {
